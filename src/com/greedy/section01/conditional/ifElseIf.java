...
public class ifElseIf {
	...
	public void testSimpleIfElseIfStatement() {
		 ...
		 * }else if(조건식2) {
		 * 	조건식1이 fasle이고 조건식2가 true일 떄 실행할 명령문;
		 * }else{
		 * 		조건식1과 조건식2가 둘 다 false일때 실행할 명령문*/
...
//		System.out.println(str1.equals(str3));
		...
		if(answer.equals("금도끼")) {
			System.out.println("이런 거짓말쟁이! 너에게는 아무 도끼도 줄 수가 없구나 이욕심쟁이야!!");
			}else if(answer.equals("은도끼")) {
				System.out.println("욕심이 과하지는 않지만 그래도 넌 나에게 거짓말을 하고 있구나!! 어서 썩 사라지거라!!");
				}else {
					System.out.println("오호~ 정직하구나~ 여기 있는 금도끼,은도끼, 쇠도끼를 다가져가러가!!");
					}
